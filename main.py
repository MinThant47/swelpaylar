...
.st-key-orange button:active {
  ...
  .bot-message {
    background: linear-gradient(135deg, rgba(247, 148, 29, 0.08), rgba(247, 148, 29, 0.05));
    backdrop-filter: blur(10px);
    border: 1px solid rgba(255, 255, 255, 0.2);
    padding: 15px 20px;
...
st.markdown(
    ...
    <style>
    .stApp {{
         background-image: url("https://img.freepik.com/free-vector/abstract-perspective-grid-lines-black-background_1017-47349.jpg?t=st=1744909163~exp=1744912763~hmac=3718d67825ec737873be32ced8b8609c84ce208a263019ab4795e88ac4d479c3&w=826");
